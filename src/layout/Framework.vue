<template>
    <div class="material-editor" ref="editor">
        ...
        <div class="material-editor-content">
            <div class="material-editor-framework-module" :style="`width:${columnWidth.module}px`">
                <slot name="module"></slot>
            </div>
            <div
                class="material-editor-framework--collapsed"
                :class="[!moduleShow || isClose ? 'material-editor-framework-transition' : '']"
                :style="{
            ...
            >
                ...
                <el-tooltip class="item" effect="dark" content="关闭侧边栏" placement="right">
                    <img
            ...
            <div class="material-editor-framework-center" :style="`width:${columnWidth.center}px`">
                <slot name="navlist"></slot>
                <slot name="workspace"></slot>
            </div>
            <div class="material-editor-framework-right" :style="`width:${columnWidth.right}px`">
...
const moduleShow = computed(() => {
    return (
        activeModule.value && !activeModule.value.drag && JSON.stringify(activeModule.value) != '{}'
    )
})
onMounted(() => {
